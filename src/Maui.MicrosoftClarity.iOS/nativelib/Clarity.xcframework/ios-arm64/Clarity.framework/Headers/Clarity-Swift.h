...
typedef SWIFT_ENUM(NSInteger, ClarityApplicationFramework, open) {
  ClarityApplicationFrameworkNative = 0,
  ClarityApplicationFrameworkCordova = 1,
  ClarityApplicationFrameworkReactNative = 2,
  ClarityApplicationFrameworkIonic = 3,
};

@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, ClarityLogLevel)
...
typedef SWIFT_ENUM(NSInteger, ClarityLogLevel, open) {
...
/// Sets the user’s consent status for data collection, which adjusts the SDK’s behavior
...
///     <ul>
///       <li>
///         You are responsible for obtaining the user’s consent. This can be achieved
///         by implementing a consent banner or another custom solution in your app.
///       </li>
///       <li>
///         This function should only be called on the main thread.
///       </li>
...
///
/// returns:
/// <code>true</code> if the consent status was set successfully; otherwise <code>false</code>.
